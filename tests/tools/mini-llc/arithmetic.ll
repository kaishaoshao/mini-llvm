...
@format2 = private global [6 x i8] c"%llx\0A\00"
...
0:
  ...
  %2 = call i32 @printf(ptr @format1, i32 %1)
  %3 = call i32 @sub(i32 42, i32 43)
  %4 = call i32 @printf(ptr @format1, i32 %3)
  %5 = call i32 @mul(i32 42, i32 43)
  %6 = call i32 @printf(ptr @format1, i32 %5)
  %7 = call i32 @sdiv(i32 -42, i32 5)
  %8 = call i32 @printf(ptr @format1, i32 %7)
  %9 = call i32 @srem(i32 -42, i32 5)
  %10 = call i32 @printf(ptr @format1, i32 %9)
  %11 = call i32 @udiv(i32 -42, i32 5)
  %12 = call i32 @printf(ptr @format1, i32 %11)
  %13 = call i32 @urem(i32 -42, i32 5)
  %14 = call i32 @printf(ptr @format1, i32 %13)
  %15 = call i32 @and(i32 305419896, i32 2271560481)
  %16 = call i32 @printf(ptr @format1, i32 %15)
  %17 = call i32 @or(i32 305419896, i32 2271560481)
  %18 = call i32 @printf(ptr @format1, i32 %17)
  %19 = call i32 @xor(i32 305419896, i32 2271560481)
  %20 = call i32 @printf(ptr @format1, i32 %19)
  %21 = call i32 @shl(i32 -42, i32 2)
  %22 = call i32 @printf(ptr @format1, i32 %21)
  %23 = call i32 @lshr(i32 -42, i32 2)
  %24 = call i32 @printf(ptr @format1, i32 %23)
  ...
  %61 = call i32 @printf(ptr @format1, i32 %60)
  %62 = call i32 @shl_ni(i32 -42, i32 2)
  %63 = call i32 @printf(ptr @format1, i32 %62)
  %64 = call i32 @lshr_ni(i32 -42, i32 2)
  %65 = call i32 @printf(ptr @format1, i32 %64)
