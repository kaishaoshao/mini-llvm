@format1 = private global [4 x i8] c"%x\0A\00"
...
0:
  ...
  %4 = call i32 @printf(ptr @format2, i64 %3)
  %5 = call i64 @zext(i32 2271560481)
  %6 = call i32 @printf(ptr @format2, i64 %5)
  %7 = call float @fptrunc(double 0x40091eb851eb851f)
  %8 = bitcast float %7 to i32
  %9 = call i32 @printf(ptr @format1, i32 %8)
  %10 = call double @fpext(float 0x40091eb860000000)
  %11 = bitcast double %10 to i64
  %12 = call i32 @printf(ptr @format2, i64 %11)
  %13 = call double @sitofp(i32 2271560481)
  %14 = bitcast double %13 to i64
  %15 = call i32 @printf(ptr @format2, i64 %14)
  %16 = call double @uitofp(i32 2271560481)
  %17 = bitcast double %16 to i64
  %18 = call i32 @printf(ptr @format2, i64 %17)
