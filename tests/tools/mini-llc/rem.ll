...
define i32 @srem_m1(i32 %0) noinline {
1:
  %2 = srem i32 %0, -1
  ret i32 %2
}

define i32 @srem_m2(i32 %0) noinline {
1:
  %2 = srem i32 %0, -2
  ret i32 %2
}

define i32 @srem_m3(i32 %0) noinline {
1:
  %2 = srem i32 %0, -3
  ret i32 %2
}

define i32 @srem_m4(i32 %0) noinline {
1:
  %2 = srem i32 %0, -4
  ret i32 %2
}

define i32 @srem_m100(i32 %0) noinline {
1:
  %2 = srem i32 %0, -100
  ret i32 %2
}

define i32 @srem_m255(i32 %0) noinline {
1:
  %2 = srem i32 %0, -255
  ret i32 %2
}

define i32 @srem_m256(i32 %0) noinline {
1:
  %2 = srem i32 %0, -256
  ret i32 %2
}

define i32 @srem_m2147483648(i32 %0) noinline {
1:
